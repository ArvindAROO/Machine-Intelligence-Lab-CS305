...
def test_case():
    ...
    # print(df[[df.columns[-1]]].values.tolist())
    try:
        ...
        print("Test Case 1 for the function get_entropy_of_dataset FAILED''''", E)

    try:
        temp = get_avg_info_of_attribute(df, 'temp')
        ...
        print("Test Case 2 for the function get_avg_info_of_attribute FAILED<", E)
    ...
    try:
        ...
        print("Test Case 3 for the function get_avg_info_of_attribute FAILED<", E)
